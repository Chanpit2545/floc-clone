...
export function Community() {
  return (
    <div className="bg-gray-100 pt-16 pb-24 px-4 sm:px-8 md:px-12 space-y-12">
      <div className="flex flex-col lg:flex-row justify-center items-center lg:gap-4 xl:gap-32">
        <div className="hidden lg:flex justify-center">
          <img
            ...
            className="w-[596px] h-auto object-contain"
          />
        </div>

        <div className="flex flex-col justify-center items-center text-center lg:items-center lg:text-center space-y-6">
          <img
          ...
          />
          <div className="text-gray-400 text-xl font-medium space-y-1">
            <p>Thrive collectively, not individually.</p>
            <p>Come fly with the flock and</p>
            <p>create new possibilities together.</p>
          </div>
          <div className="flex justify-center items-center gap-4 text-xl">
            <div className="text-blue-600 bg-white p-2 border border-gray-300 rounded-full shadow-md hover:bg-gray-100 hover:border-blue-700 active:bg-[#dbd5ff]">
              <FaFacebook />
            </div>
            <div className="bg-white p-2 border border-gray-300 rounded-full shadow-md hover:bg-gray-100 hover:border-blue-700 active:bg-[#dbd5ff]">
              <BsInstagram />
            </div>
            <div className="bg-white p-2 border border-gray-300 rounded-full shadow-md hover:bg-gray-100 hover:border-blue-700 active:bg-[#dbd5ff]">
              <FaTiktok />
      ...
      <div>
        <Marquee autoFill pauseOnHover direction="left">
          <div className="flex flex-col rounded-xl bg-white w-[300px] sm:w-[350px] md:w-[400px] h-[172px] shadow-lg mx-4">
