    ...
    <div className="relative flex justify-center items-center pt-16 pb-32 px-4 sm:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="text-center justify-items-center md:text-left pt-8">
          <h2 className="text-3xl text-center sm:text-4xl md:text-5xl font-bold break-words whitespace-normal">
            Creating new opportunities
          </h2>
          <p className="text-xl text-center sm:text-2xl font-semibold text-gray-800 mt-4">
